    ...
    <div className='font-sans text-sm'>
        ...
        <div className='p-16 min-w-[500px]'>
          ...
          <div bg>
            ...
            <div className="pb-10">
              <input className="mb-2 pl-1 py-0.5 border border-gray-400 w-full" placeholder="joku@example.com" type="email" id="email" name="email"/>
              <input className="border pl-1 py-0.5 border-gray-400 w-full" placeholder="Salasana" type="password" id="password" name="password"/>
            </div>
            <Link href="/message">
