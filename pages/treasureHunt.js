      ...
      >
        ...
        <div className="w-auto md:h-full md:text-xl">
          <div className="flex flex-col items-center md:h-fit md:pt-[40%]">
            ...
            <button
              className="px-5 py-2  bg-nord3 rounded-md hover:scale-110 transition ease-in-out mb-10"
