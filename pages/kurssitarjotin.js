...
const leakInfo = [
  ...
  "24,EAB37.1,HI03.1,FI04.1,BI05.2,PS04.1,RUA08.1,RUB16.1,ENA08.4,LI04.1,MAA10.4,MAB10.7,MAB07.2,ÄI08.2,ÄI11.2,ÄI08.7,MU03.1",
        ...
        <div className="text-nord4">
          ...
          <div className="mt-3 w-5/6 mx-auto">
            ...
            <p className=" text-center text-xs mt-2">
              päivitetty 12.5.2022 klo 12.10
            </p>
            <p className=" text-center text-xs mt-2">
